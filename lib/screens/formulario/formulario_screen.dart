  ...
  class _FormularioScreenState extends State<FormularioScreen>
    ...
    Widget _buildBombasStep() {
      return _buildStepContainer(
        ...
        children: widget.estacion.bombas.map((b) => _buildBombaCard(b)).toList(),
      );
    }
    ...
    Widget _buildBombaCard(BombaModel bomba) {
      ...
      return Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(color: _border, width: 1.5),
          boxShadow: [BoxShadow(color: _primary.withOpacity(0.05), blurRadius: 12,
              offset: const Offset(0, 4))],
        ),
        child: Column(children: [
          // Header
          Container(
            ...
            decoration: BoxDecoration(
              gradient: LinearGradient(
                  colors: [_primary.withOpacity(0.08), _accent.withOpacity(0.04)]),
              ...
              if (esDiaSig)
                Container(
                  ...
                  child: const Row(children: [
                    Icon(Icons.nights_stay_rounded, size: 12, color: Color(0xFF7B1FA2)),
                    SizedBox(width: 4),
                    Text('Turno nocturno',
            ...
            Expanded(
              child: ElevatedButton(
                ...
                child: _isLoading
                  ...
                  Icon(isLast ? Icons.cloud_upload_rounded : Icons.arrow_forward_rounded,
                      size: 18),
                  const SizedBox(width: 8),
