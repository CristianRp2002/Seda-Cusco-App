...
class _FormularioScreenState extends State<FormularioScreen>
  ...
  String _horaAIso(String? horaHHmm, {bool esSiguienteDia = false, DateTime? fechaBase}) {
    ...
    final base  = fechaBase ?? DateTime.now();
  ...
  Future<void> _guardar() async {
    ...
    try {
      ...
      for (final bomba in _bombasSeleccionadas) {
        ...
        final esBombaExtra = _bombasExtra.any((b) => b.id == bomba.id);

        if (encendido != null && apagado != null) {
          bombeos.add({
            'bomba_id':          esBombaExtra ? null : bomba.id,
            'nombre_bomba_nueva': esBombaExtra ? bomba.nombre : null,
            'encendido':         encendido,
            'apagado':           apagado,
            'horometro_inicial': horIni != null ? double.tryParse(horIni) : null,
            'horometro_final':   horFin != null ? double.tryParse(horFin) : null,
